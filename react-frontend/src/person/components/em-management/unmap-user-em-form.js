...
class UnmapUserEmForm extends React.Component {
    ...
    unmapUserEm(pair) {
        return API_EM_USER.unmapUserToEm(pair, (result, status, error) => {
...
export default UnmapUserEmForm;
