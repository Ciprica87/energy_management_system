...
class DeleteEmForm extends React.Component {
    ...
    deleteEnergyMeter(id) {
        return API_EM.deleteEnergyMeter(id, (result, status, error) => {
    ...
    handleSubmit() {
        this.deleteEnergyMeter(this.state.formControls.id.value);
    }
